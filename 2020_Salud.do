...
global dir "C:\Users\Z50-CORE-I5\Desktop\Social Mobility Measure\Salud2"
cd "$dir"

use "$dir\enaho01a-2020-400.dta", clear
...
save "$dir\base4.dta", replace

*************************************************
************* MODULO EMPLEO E INGRESOS **********
*************************************************
use "$dir\enaho01a-2020-500.dta", clear
