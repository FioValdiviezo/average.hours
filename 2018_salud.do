...
global dir "C:\Users\Z50-CORE-I5\Desktop\Social Mobility Measure\Salud"
cd "$dir"

use "$dir\enaho01a-2018-400.dta"
...
save "$dir\base2.dta", replace

*************************************************
************* MODULO EMPLEO E INGRESOS **********
*************************************************
use "$dir\enaho01a-2018-500.dta", clear
...
sort conglome vivienda hogar ubigeo
* ahora unimos tanto la base Empleo y la base Salud/ ambas tienen los mismos identificadores
merge 1:1 ubigeo conglome vivienda hogar codperso using "base2.dta"
drop _m 
